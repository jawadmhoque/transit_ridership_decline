...
def get_subclusterwise_charts(_df, _chart_name, _clusterfile, _filename, _subcluster,pct_change_value):
    ...
    for mode in modes:
        ...
        fig, ax = plt.subplots(nrows=2, ncols=2, figsize=(20, 20), constrained_layout=False, squeeze=False)
        ...
        fig.text(0.02, 0.5, ('Percent Change in Ridership from ' + str(b)), ha='center', va='baseline', rotation='vertical',
                 fontsize=16)
        ...
        plt.suptitle("Percent Change in Ridership from 2002", fontsize=16)
...
def get_subclustercharts_clusterwise(_df, _chart_name, _clusterfile, _filename, _subcluster,pct_change_value):
    ...
    for cluster in clusters:
        ...
        fig, ax = plt.subplots(nrows=2, ncols=1, figsize=(20, 20), constrained_layout=False, squeeze=False)
        col = 0
        row = 0
        if cluster == 1:
