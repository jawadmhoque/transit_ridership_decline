...
def prepare_dataframe(df):
    ...
    for metro in tqdm(metro_names):
        ...
        current_dir = current_dir.parents[0] / 'Script Outputs' / 'Est9_Outputs' / 'Model1' /'Metro_Area_CSVs'
        os.chdir(str(current_dir))
...
def prepare_summary_sheet(df_filter, start_year, end_year, file_name):
    ...
    current_dir = current_dir.parents[0] / 'Script Outputs' / 'Est9_Outputs' / 'Model1' / 'Template'
    os.chdir(str(current_dir))
    ...
    current_dir = pathlib.Path(__file__).parent.absolute()
    current_dir = current_dir.parents[0] / 'Script Outputs' / 'Est9_Outputs' / 'Model1' / 'FAC Summary Reports'
    os.chdir(str(current_dir))
...
def prepare_chart(df, start_year, end_year, file_name):
    ...
    outputdirectory = "Est9_Outputs/Model1/Metro_Area"
    p = pathlib.Path(outputdirectory)
    p.mkdir(parents=True, exist_ok=True)
    current_dir = current_dir.parents[0] / 'Script Outputs' / outputdirectory
    os.chdir(str(current_dir))
...
def main():
    ...
    read_the_FAC_file("FAC_Model1.csv",filepath)
